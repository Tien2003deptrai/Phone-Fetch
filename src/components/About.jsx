            ...
            <div className="container py-5 my-5">
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex justify-content-center">
                        <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:0:358/q:80/plain/https://cellphones.com.vn/media/catalog/product/v/n/vn_iphone_15_pink_pdp_image_position-7_features_specs_2.jpg" alt="About Us" height="400px" width="400px" />
                    </div>
                </div>
            </div>
        </div>
